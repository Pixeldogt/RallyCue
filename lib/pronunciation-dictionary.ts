...
export const BUILTIN_PRONUNCIATION_DICTIONARY = [
  ...
  { source: 'George', replacement: 'Tschortsch' },
  ...
  { source: 'Sidita', replacement: 'Siedie-da' },
  { source: 'Reichstein', replacement: 'Raichschtain' },
  { source: 'Ben', replacement: 'Benn' },
  { source: 'Max', replacement: 'Macks' },
